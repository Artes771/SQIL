...
describe('PermissionCreateDialogComponent', () => {

    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [PermissionCreateDialogComponent],
    ...
    it('should create component instance', () => {
        const fixture = TestBed.createComponent(PermissionCreateDialogComponent);
