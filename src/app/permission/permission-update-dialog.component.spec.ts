...
describe('PermissionUpdateDialogComponent', () => {

    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [PermissionUpdateDialogComponent],
            imports: [    
                MatToolbarModule,
                MatButtonModule,
                MatTableModule,
    ...
    it('should create component instance', () => {
        const fixture = TestBed.createComponent(PermissionUpdateDialogComponent);
